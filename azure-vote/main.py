...
appInsightConnectionStr = os.environ.get('AppInsightConnectionString')

# Logging
logger = logging.getLogger(__name__)
handler = AzureLogHandler(connection_string=appInsightConnectionStr)
handler.setFormatter(logging.Formatter('%(traceId)s %(spanId)s %(message)s'))
logger.addHandler(handler)
# Logging custom Events 
logger.addHandler(AzureEventHandler(connection_string=appInsightConnectionStr))
...
middleware = FlaskMiddleware(
    app,
    exporter=AzureExporter(connection_string=appInsightConnectionStr),
